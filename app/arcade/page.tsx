...
import { Sparkles, Zap, ShoppingCart, Trophy, ArrowLeft, Target } from 'lucide-react'
import VisionaryGame from '@/components/arcade/VisionaryGame'
import AlgorithmGame from '@/components/arcade/AlgorithmGame'
import NeuralChess from '@/components/arcade/NeuralChess'
import { GAME_ASSETS } from '@/lib/game/assets'

type ArcadeGame = 'SELECT' | 'VISIONARY' | 'ALGORITHM' | 'NEURAL_CHESS'
...
export default function ArcadePage() {
  ...
  const games = [
    ...
    {
      id: 'NEURAL_CHESS' as ArcadeGame,
      name: 'Neural Chess',
      description: 'Play chess against an AI that learns from your moves',
      icon: Target,
  ...
  if (selectedGame !== 'SELECT') {
    ...
    return (
      <div className="min-h-screen bg-slate-900">
        ...
        {selectedGame === 'NEURAL_CHESS' && <NeuralChess />}
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/10 to-slate-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl">
        ...
        <p className="text-xl md:text-2xl text-gray-400 mb-2">Instant Games - No Career Required</p>
        <p className="text-sm md:text-base text-gray-500">Jump in and play anytime</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {games.map((game) => {
            ...
            const coverImage = 
              ...
              game.id === 'NEURAL_CHESS' ? GAME_ASSETS.neuralChess :
              null
              ...
              <button
                ...
                style={{
                  borderColor: game.id === 'VISIONARY' ? 'rgba(168, 85, 247, 0.5)' :
                              ...
                              game.id === 'NEURAL_CHESS' ? 'rgba(6, 182, 212, 0.5)' :
                              'rgba(6, 182, 212, 0.5)',
                }}
              >
